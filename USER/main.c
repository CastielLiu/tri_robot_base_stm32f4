...
u8 Flag_Stop=1,Flag_Show=1;                 //停止标志位和 显示标志位 默认停止 显示关闭
...
u8 Usart_Invalid_Count=0; //串口失效计数，超出一定时间未收到串口数据则失能串口控制
...
float Velocity_KP=10,Velocity_KI=2;	          //速度控制PID参数
...
//	CAN1_SEND();                //CAN发送	      //暂不使用CAN发送
//	PS2_Receive();             //PS2接收        //暂未使用PS2
		USART_TX();                //串口发送
